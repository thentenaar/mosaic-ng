...
static String color_resources[] = {
  "*XmLabel*fontList:   		-*-*-bold-r-normal-*-14-*-*-*-*-*-iso8859-1",
  "*XmLabelGadget*fontList:	-*-*-bold-r-normal-*-14-*-*-*-*-*-iso8859-1",
  "*XmScale*fontList:   		-*-*-bold-r-normal-*-14-*-*-*-*-*-iso8859-1",
  "*XmBulletinBoard*labelFontList:	-*-*-bold-r-normal-*-14-*-*-*-*-*-iso8859-1",
  "*optionmenu.XmLabelGadget*fontList:	-*-*-bold-r-normal-*-14-*-*-*-*-*-iso8859-1",
  "*XmPushButton*fontList:		-*-*-medium-r-normal-*-14-*-iso8859-1",
  "*XmPushButtonGadget*fontList:	-*-*-medium-r-normal-*-14-*-iso8859-1",
  "*XmToggleButton*fontList:	-*-*-medium-r-normal-*-14-*-iso8859-1",
  "*XmToggleButtonGadget*fontList:	-*-*-medium-r-normal-*-14-*-iso8859-1",
  "*optionmenu*fontList:		-*-*-medium-r-normal-*-14-*-iso8859-1",
  "*XmIconGadget*fontList:		-*-*-medium-r-normal-*-14-*-iso8859-1",
  "*XmBulletinBoard*buttonFontList: -*-*-medium-r-normal-*-14-*-iso8859-1",
  "*menubar*fontList:   		-*-*-bold-o-normal-*-14-*-iso8859-1",
  "*XmMenuShell*XmPushButton*fontList:  -*-*-bold-o-normal-*-14-*-iso8859-1",
  "*XmMenuShell*XmLabelGadget*fontList: -*-*-bold-o-normal-*-14-*-iso8859-1",
  "*XmMenuShell*XmPushButtonGadget*fontList: -*-*-bold-o-normal-*-14-*-iso8859-1",
  "*XmMenuShell*XmCascadeButton*fontList: -*-*-bold-o-normal-*-14-*-iso8859-1",
  "*XmMenuShell*XmCascadeButtonGadget*fontList: -*-*-bold-o-normal-*-14-*-iso8859-1",
  "*XmCascadeButton*fontList: -*-*-bold-o-normal-*-14-*-iso8859-1",
  "*XmCascadeButtonGadget*fontList: -*-*-bold-o-normal-*-14-*-iso8859-1",
  "*XmMenuShell*XmToggleButton*fontList: -*-*-bold-o-normal-*-14-*-iso8859-1",
  "*XmMenuShell*XmToggleButtonGadget*fontList: -*-*-bold-o-normal-*-14-*-iso8859-1",
  "*pulldownmenu*fontList:	-*-*-bold-o-normal-*-14-*-iso8859-1",
  "*XmList*fontList:	-*-*-medium-r-normal-*-14-*-iso8859-1",
  "*XmText*fontList:      -*-*-medium-r-normal-*-14-*-iso8859-1",
  "*XmTextField*fontList: -*-*-medium-r-normal-*-14-*-iso8859-1",
  ...
  "*MeterFont: -adobe-courier-bold-r-normal-*-14-*-*-*-*-*-iso8859-1",
